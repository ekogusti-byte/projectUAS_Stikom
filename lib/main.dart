...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Eko Gusti Putro'),
    );
  }
}
        ...
        child: new Center(
            child: new FutureBuilder(
              ...
              builder: (context, snapshot) {
                ...
                new Center(child:
                new Text('Tidak ditemukan data transaksi, tambahkan data dengan tombol (plus)!', style: Theme.of(context).textTheme.headline6));
              },
            )
        ),
      ),
